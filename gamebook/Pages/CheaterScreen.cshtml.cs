...
{
    public class CheaterScreenModel : PageModel
    {
        ...
        public CheaterScreenModel(ISessionStorage<GameState> ss, IPlaceMover pm, ISessionStorage<GameState> dd)
        {
            _ss = ss;
            _pm = pm;
            _dd = dd;
        ...
        public ActionResult OnGet(Places id = 0)
        {
